...
# from jax_marl.environments.smax import map_name_to_scenario
...
def single_run(config):
    ...
    if config.get("SAVE_PATH", None) is not None:
        from jax_marl.wrappers.baselines import save_params
...
@hydra.main(version_base=None, config_path="./config", config_name="ql_overcooked")
def main(config):
