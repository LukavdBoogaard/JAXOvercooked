...
from jax_marl.environments.overcooked_environment.overcooked import POT_FULL_STATUS, DELIVERY_REWARD
...
# ---------------------------------------------------------------------
env = OvercookedSingle(layout=FrozenDict(cramped_room),
                       random_reset=False, max_steps=400)
...
# 4. Write GIF
# ---------------------------------------------------------------------
gif_path = "cramped_room_demo.gif"
